            ...
            <div className="col-xl-2 col-none info-container">
              <div className="row">
                <div className="col-xl-6 info-container-item">
                  <div
                    onClick={handleShow}
                    className=" info-container-link info-container-login"
                  >
                    Đăng nhập
                  </div>
                </div>
                    ...
                    <li className="cartList--item">
                      <div className="row">
                        <div className="col-xl-4">
                          <a href="#" className="cartList--item-link">
                            <img
                        ...
                        <div className="col-xl-8 cartList--item-introduce">
                          <div className="cartList--item-name">
                          <a href="#" className="cartList--item-link">
                            <span>HONDA CITY 2019</span>
                          </a>
                          </div>
                          <div className="cartList--item-price">
                            900k
                          </div>
                        </div>
                      </div>
            ...
            <div className="models-body">
              <div className="models-default">
                ...
                <div className="line-form has-ico line-login-text">
                  <p>
                    Bạn chưa là thành viên? <a href="#">Hãy đăng kí ngay!</a>
                  </p>
                </div>
              ...
              <div className="row payment-item">
                <div className=" col-xl-3 payment-wrap">
                  <div className="payment-wrap-item">
                    <div className="fix-img">
                      <img
                        src="https://www.mioto.vn/static/media/momo.3e212754.png"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="col-xl-3 payment-wrap">
                  <div className="payment-wrap-item">
                    <div className="fix-img">
                      <img
                        src="https://www.mioto.vn/static/media/vnpay.cbe63a22.svg"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <div className="payment-wrap col-xl-3">
                  <div className="payment-wrap-item">
                    <div className="fix-img">
                      <img
                        src="https://www.mioto.vn/static/media/alepay.a0b2802b.png"
                        alt=""
                      />
                    </div>
                  </div>
                ...
                <li className="part-list-item">
                  <a href="#">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_9159_4908)">
                        <path
